...
},{}],"node_modules/@firebase/auth/dist/esm2017/index-77658911.js":[function(require,module,exports) {
"use strict";
...
var _index = require("./index-77658911.js");
var _util = require("@firebase/util");
...
async function _generateHandlerUrl(auth, event, provider) {
  ...
  (0, _index.au)(event.sessionId, 'AuthEvent did not contain a session ID');
  ...
  if ((0, _index.av)()) {
    ...
    (0, _index.ax)(auth, "operation-not-supported-in-this-environment" /* AuthErrorCode.OPERATION_NOT_SUPPORTED */);
  }
  ...
  return (0, _index.ay)(auth, provider, event.type, undefined, (_a = event.eventId) !== null && _a !== void 0 ? _a : undefined, additionalParams);
}
/**
...
async function _validateOrigin(auth) {
  ...
  await (0, _index.az)(auth, request);
}
  ...
  return new Promise(resolve => {
    cordova.plugins.browsertab.isAvailable(browserTabIsAvailable => {
      ...
      if (browserTabIsAvailable) {
        ...
        iabRef = cordova.InAppBrowser.open(handlerUrl, (0, _index.aA)() ? '_blank' : '_system', 'location=yes');
      }
      resolve(iabRef);
    });
  });
    ...
    await new Promise((resolve, reject) => {
      ...
      function resumed() {
        ...
        onCloseTimer = window.setTimeout(() => {
          ...
          reject((0, _index.aB)(auth, "redirect-cancelled-by-user" /* AuthErrorCode.REDIRECT_CANCELLED_BY_USER */));
        }, REDIRECT_TIMEOUT_MS);
      }
...
function _checkCordovaConfiguration(auth) {
  ...
  (0, _index.aC)(typeof ((_a = win === null || win === void 0 ? void 0 : win.universalLinks) === null || _a === void 0 ? void 0 : _a.subscribe) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, {
    missingPlugin: 'cordova-universal-links-plugin-fix'
  });
  // https://www.npmjs.com/package/cordova-plugin-buildinfo
  (0, _index.aC)(typeof ((_b = win === null || win === void 0 ? void 0 : win.BuildInfo) === null || _b === void 0 ? void 0 : _b.packageName) !== 'undefined', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, {
    missingPlugin: 'cordova-plugin-buildInfo'
  });
  // https://github.com/google/cordova-plugin-browsertab
  (0, _index.aC)(typeof ((_e = (_d = (_c = win === null || win === void 0 ? void 0 : win.cordova) === null || _c === void 0 ? void 0 : _c.plugins) === null || _d === void 0 ? void 0 : _d.browsertab) === null || _e === void 0 ? void 0 : _e.openUrl) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, {
    missingPlugin: 'cordova-plugin-browsertab'
  });
  (0, _index.aC)(typeof ((_h = (_g = (_f = win === null || win === void 0 ? void 0 : win.cordova) === null || _f === void 0 ? void 0 : _f.plugins) === null || _g === void 0 ? void 0 : _g.browsertab) === null || _h === void 0 ? void 0 : _h.isAvailable) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, {
    missingPlugin: 'cordova-plugin-browsertab'
  });
  // https://cordova.apache.org/docs/en/latest/reference/cordova-plugin-inappbrowser/
  (0, _index.aC)(typeof ((_k = (_j = win === null || win === void 0 ? void 0 : win.cordova) === null || _j === void 0 ? void 0 : _j.InAppBrowser) === null || _k === void 0 ? void 0 : _k.open) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, {
...
function stringToArrayBuffer(str) {
  ...
  (0, _index.au)(/[0-9a-zA-Z]+/.test(str), 'Can only convert alpha-numeric strings');
...
class CordovaAuthEventManager extends _index.aD {
  constructor() {
    super(...arguments);
...
function _generateNewEvent(auth, type, eventId = null) {
  return {
    ...
    postBody: null,
    tenantId: auth.tenantId,
    error: (0, _index.aB)(auth, "no-auth-event" /* AuthErrorCode.NO_AUTH_EVENT */)
  };
}
...
function _eventFromPartialAndUrl(partialEvent, url) {
  ...
  if (callbackUrl.includes('/__/auth/callback')) {
    ...
    const error = code ? (0, _index.aB)(code) : null;
    if (error) {
      return {
...
function storage() {
  return (0, _index.aE)(_index.b);
}
function persistenceKey(auth) {
  return (0, _index.aF)("authEvent" /* KeyName.AUTH_EVENT */, auth.config.apiKey, auth.name);
}
...
class CordovaPopupRedirectResolver {
  constructor() {
    this._redirectPersistence = _index.a;
    this._shouldInitProactively = true; // This is lightweight for Cordova
    this.eventManagers = new Map();
    this.originValidationPromises = {};
    this._completeRedirectFn = _index.aG;
    this._overrideRedirectResult = _index.aH;
  }
...
function generateNoEvent() {
  return {
    ...
    postBody: null,
    tenantId: null,
    error: (0, _index.aB)("no-auth-event" /* AuthErrorCode.NO_AUTH_EVENT */)
  };
}
...
function addFrameworkForLogging(auth, framework) {
  (0, _index.aJ)(auth)._logFramework(framework);
}
},{"./index-77658911.js":"node_modules/@firebase/auth/dist/esm2017/index-77658911.js","@firebase/util":"node_modules/@firebase/util/dist/index.esm2017.js","@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js","@firebase/logger":"node_modules/@firebase/logger/dist/esm/index.esm2017.js","tslib":"node_modules/tslib/tslib.es6.js","@firebase/component":"node_modules/@firebase/component/dist/esm/index.esm2017.js"}],"node_modules/@firebase/auth-compat/dist/index.esm2017.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{"@firebase/auth-compat":"node_modules/@firebase/auth-compat/dist/index.esm2017.js"}],"firebase/firebaseConfiguration.js":[function(require,module,exports) {
"use strict";
...
var firebaseApp = exports.firebaseApp = _app.default.initializeApp(firebaseConfig);
},{"firebase/compat/app":"node_modules/firebase/compat/app/dist/esm/index.esm.js","firebase/compat/auth":"node_modules/firebase/compat/auth/dist/esm/index.esm.js"}],"node_modules/firebase/app/dist/esm/index.esm.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js"}],"node_modules/@firebase/auth/dist/esm2017/index.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/auth":"node_modules/@firebase/auth/dist/esm2017/index.js"}],"scripts/utilities.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.assignClick = void 0;
var _app = _interopRequireDefault(require("firebase/app"));
require("firebase/auth");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var assignClick = exports.assignClick = function assignClick(elementId, func) {
  var element = document.getElementById(elementId);
  if (element) {
    element.addEventListener('click', func);
  }
};
},{"firebase/app":"node_modules/firebase/app/dist/esm/index.esm.js","firebase/auth":"node_modules/firebase/auth/dist/esm/index.esm.js"}],"firebase/firebaseAuthentication.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.twitterSignin = exports.phoneSignup = exports.googleSignin = exports.facebookSignin = exports.emailSignup = exports.emailSignin = void 0;
var _app = _interopRequireDefault(require("firebase/compat/app"));
var _auth = require("firebase/compat/auth");
var _firebaseConfiguration = _interopRequireDefault(require("../firebase/firebaseConfiguration.js"));
var _auth2 = require("firebase/auth");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// For Firebase version 9+
// For Firebase version 9+
// Adjust the path as needed
// Import GoogleAuthProvider from the compat version

var googleSignin = exports.googleSignin = function googleSignin() {
  ...
  _app.default.auth().signInWithPopup(provider).then(function (result) {
    ...
    return console.error('There was an error with signing into Google: ', error);
  });
};
var facebookSignin = exports.facebookSignin = function facebookSignin() {
  var provider = new _app.default.auth.FacebookAuthProvider();
  _app.default.auth().signInWithPopup(provider).then(function (result) {
    localStorage.setItem('loginMessage', 'Successfully logged in: ' + result.user.displayName);
    window.location.href = "project3.html"; // Redirect to project3.html
  }).catch(function (error) {
    return console.error('There was an error with signing into Facebook: ', error);
  });
};
var twitterSignin = exports.twitterSignin = function twitterSignin() {
  var provider = new _app.default.auth.TwitterAuthProvider();
  _app.default.auth().signInWithPopup(provider).then(function (result) {
    localStorage.setItem('loginMessage', 'Successfully logged in: ' + result.user.displayName);
    window.location.href = "project3.html"; // Redirect to project3.html
  }).catch(function (error) {
    return console.error('There was an error with signing into Twitter: ', error);
  });
};
...
var emailSignup = exports.emailSignup = function emailSignup(event, email, password) {
  event.preventDefault(); // Prevent the default form submission behavior
  var auth = (0, _auth2.getAuth)();
  (0, _auth2.createUserWithEmailAndPassword)(auth, email, password).then(function () {
    ...
    return console.error('There was an error while creating an account: ', error);
  });
};
...
var emailSignin = exports.emailSignin = function emailSignin(event, email, password) {
  event.preventDefault(); // Prevent the default form submission behavior
...
var phoneSignup = exports.phoneSignup = function phoneSignup(phoneNumber) {
  var auth = (0, _auth2.getAuth)(_firebaseConfiguration.default);
  var recaptchaVerifier = new _auth2.RecaptchaVerifier(auth, 'recaptcha-container', {});
  recaptchaVerifier.render().then(function () {
    (0, _auth2.signInWithPhoneNumber)(auth, phoneNumber, recaptchaVerifier).then(function (confirmationResult) {
...
},{"firebase/compat/app":"node_modules/firebase/compat/app/dist/esm/index.esm.js","firebase/compat/auth":"node_modules/firebase/compat/auth/dist/esm/index.esm.js","../firebase/firebaseConfiguration.js":"firebase/firebaseConfiguration.js","firebase/auth":"node_modules/firebase/auth/dist/esm/index.esm.js"}],"scripts/index.js":[function(require,module,exports) {
"use strict";
...
// Import emailSignup function
// Import phoneSignup function

var phoneSignupForm = document.getElementById('phone-signup-form');
if (phoneSignupForm) {
  phoneSignupForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var phoneNumber = phoneSignupForm['phone-number'].value;
    (0, _firebaseAuthentication.phoneSignup)(phoneNumber);
  });
}
...
if (emailSigninForm) {
  emailSigninForm.addEventListener('submit', function (event) {
    var email = emailSigninForm['email'].value;
    var password = emailSigninForm['password'].value;
    (0, _firebaseAuthentication.emailSignin)(event, email, password);
  });
}
var emailSignupForm = document.getElementById('email-signup-form');
if (emailSignupForm) {
  emailSignupForm.addEventListener('submit', function (event) {
    var email = emailSignupForm['new-email'].value;
    var password = emailSignupForm['new-password'].value;
    (0, _firebaseAuthentication.emailSignup)(event, email, password);
  });
}
},{"../firebase/firebaseConfiguration.js":"firebase/firebaseConfiguration.js","./utilities.js":"scripts/utilities.js","../firebase/firebaseAuthentication":"firebase/firebaseAuthentication.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
